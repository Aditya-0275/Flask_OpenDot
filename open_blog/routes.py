...
from open_blog.forms import RegistrationForm, LoginForm, UpdateAccountForm, PostForm, RequestResetForm, ResetPasswordForm
from open_blog.models import User, Post
from open_blog import app, db, bcrypt, mail
